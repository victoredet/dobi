        ...
        <div class="col-10 content animate__animated animate__bounce vh-100 p-4">
            <div class="col-md-9 col-11 mx-auto ">
                <div class="col-12 p-3 d-flex card shadow-sm m-2">
                   ...
                   <div v-for="withdraw in withdrawals" :key="withdraw.id" class="user m-1 container col-12 border border-2 py-2">
                     joijo
                   </div>
                </div>
            </div> 
...
export default{
    ...
    async mounted(){
      await axios.get('https://www.app.a1tradefx.com/backend/public/api/get_withdrawals',{
        headers:{
